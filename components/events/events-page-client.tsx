            ...
            <div ref={openMenuEventId === eventItem.id ? menuAreaRef : null} className="relative">
              <div className="relative">
                ...
                {openMenuEventId === eventItem.id ? (
                  <div className="absolute right-0 top-[calc(100%+0.25rem)] z-[90] min-w-[148px] overflow-hidden rounded-[14px] border border-border menu-surface shadow-[0_4px_12px_rgba(68,52,35,0.08)]">
                    <button
