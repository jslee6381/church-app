...
export function PrayerPageClient({
  ...
  return (
    <main className="shell flex min-h-screen max-w-[560px] flex-col pb-40 pt-6">
      ...
      <div className="prayer-composer-shell fixed inset-x-0 bottom-[calc(env(safe-area-inset-bottom)+24px)] z-30 bg-[linear-gradient(180deg,rgba(224,224,224,0.56)_0%,rgba(224,224,224,0.92)_18%,rgba(224,224,224,1)_100%)] px-3 pb-3 pt-2 backdrop-blur-2xl">
