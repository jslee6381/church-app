...
export function PrayerPageClient({
  ...
  return (
    <main className="shell flex min-h-screen max-w-[560px] flex-col pb-40 pt-6">
      ...
      <div className="prayer-composer-shell fixed inset-x-0 bottom-0 z-30 bg-[linear-gradient(180deg,rgba(246,241,232,0.56)_0%,rgba(246,241,232,0.92)_18%,rgba(246,241,232,1)_100%)] px-3 pb-[calc(env(safe-area-inset-bottom)+14px)] pt-2 backdrop-blur-2xl">
                ...
                <div className="grid gap-3">
                  <div className="relative flex-1">
                    {isComposerExpanded ? (
                      ...
                      <button
                        className="prayer-form-input flex h-10 min-h-10 w-full items-center rounded-[16px] border border-input bg-white px-4 pr-12 text-left text-base text-muted-foreground"
