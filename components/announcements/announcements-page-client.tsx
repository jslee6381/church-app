...
export function AnnouncementsPageClient({ initialAnnouncements, canCompose }: Props) {
  ...
  const [openMenuAnnouncementId, setOpenMenuAnnouncementId] = useState<string | number | null>(null);
  ...
  function startEditing(item: AnnouncementItem) {
    ...
    setImageFile(null);
    setImagePreviewUrl(null);
    setExistingImageUrl(item.posterSrc ?? null);
    setRemoveExistingImage(false);
    setIsComposerOpen(false);
    setOpenMenuAnnouncementId(null);
  }
          ...
          current.map((item) =>
            item.id === editingId
              ? {
                  ...
                  title: nextTitle,
                  body: nextBody,
                  posterSrc: removeExistingImage ? undefined : (imagePreviewUrl ?? existingImageUrl ?? undefined),
                  posterAlt:
                    removeExistingImage
                      ? undefined
  ...
  async function deleteAnnouncement(announcementId: string | number) {
